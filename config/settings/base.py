...
)  # (sme_apps/config/settings/base.py - 3 = sme_apps/)
APPS_DIR = ROOT_DIR.path("sme_apps")
...
LOCAL_APPS = [
    "sme_apps.core.apps.CoreConfig",
    "sme_apps.users.apps.UsersConfig",
...
MIGRATION_MODULES = {"sites": "sme_apps.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "sme_apps.utils.context_processors.settings_context",
            ],
        },
    }
]
...
# # https://django-allauth.readthedocs.io/en/latest/configuration.html
# ACCOUNT_ADAPTER = "sme_apps.users.adapters.AccountAdapter"
# # https://django-allauth.readthedocs.io/en/latest/configuration.html
# SOCIALACCOUNT_ADAPTER = "sme_apps.users.adapters.SocialAccountAdapter"
# # django-compressor
# ------------------------------------------------------------------------------
